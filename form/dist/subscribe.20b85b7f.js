...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"scss/form.scss":[function(require,module,exports) {
...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"modules/dom-helpers.js":[function(require,module,exports) {
"use strict";
...
function matches(elem, selector) {
  var isMsMatch = 'msMatchesSelector' in elem && elem.msMatchesSelector(selector);
  var isMatchSelector = 'matchesSelector' in elem && elem.matchesSelector(selector);
  var isMatch = 'matches' in elem && elem.matches(selector); // Test the element to see if it matches the provided selector
  // use different methods for compatibility

  return isMsMatch || isMatchSelector || isMatch; // Return the result of the test
...
function on(el, evtName, selector, callback) {
...
},{}],"modules/compound-field.js":[function(require,module,exports) {
"use strict";
...
var IS_INTERACTED_WITH_CLASS = 'is-interacted-with';
var IS_INTERACTING_WITH_CLASS = 'is-interacting-with';
var IS_EDITED_CLASS = 'is-edited';
var IS_FOCUSED_CLASS = 'is-focused';
var IS_ACTIVE_CLASS = 'is-active';

var CompoundField = /*#__PURE__*/function () {
  function CompoundField(options) {
    var _this = this;

    _classCallCheck(this, CompoundField);

    _defineProperty(this, "_onFieldBlur", function (evt) {
      _this.el.querySelector('.compound-field-proxy .textfield').value = _this._getCompoundValue();
      _this.focusedTimeout = setTimeout(function () {
        if (!_this.el.querySelectorAll('input:focus').length) {
          _this._deactivate();

          _this._setInteracted();
        }
      }, 10);

      _this._setFieldInteracted(evt.target, true);
    });

    _defineProperty(this, "_onProxyFocus", function () {
      _this._resetInteracted(); // apply class to use for css rules - background color of technically-not-focused input in group, etc.


      _this.el.classList.add(IS_INTERACTING_WITH_CLASS);

      _this.el.querySelector(".textfield[name=\"".concat(_this._fields[0], "\"]")).focus();
    });
  ...
  _createClass(CompoundField, [{
    key: "_addEventListeners",
    value: function _addEventListeners() {
      (0, _domHelpers.on)(this.el, 'blur', 'input', function () {
        debugger;
      });
      var inputs = this.el.querySelectorAll('.enhanced-input:not(.compound-field-proxy) input');
      ...
      (0, _domHelpers.on)(this.el, 'focus', 'input', this._onFieldFocused);
    }
  }, {
    key: "_onFieldFocused",
    value: function _onFieldFocused(evt) {
      if (!this._isActive) {
        this._isActive = true;
    ...
    key: "_setFieldInteracted",
    value: function _setFieldInteracted($input) {
      this._interactedFields.push($input.getAttribute('name'));
    }
  }, {
    key: "_setInteracted",
    value: function _setInteracted() {
      var compoundValue = this._getCompoundValue();
    ...
    key: "_resetInteracted",
    value: function _resetInteracted() {
      this._interactedFields = [];
      this._interacted = false;
    ...
    value: function _getCompoundValue() {
      var val = '';

      for (var i = 0; i < this._fields.length; i++) {
        val += this.el.querySelector(".textfield[name=\"".concat(this._fields[i], "\"]")).value + ' ';
      }
...
},{"./dom-helpers":"modules/dom-helpers.js"}],"modules/validation-messages.json":[function(require,module,exports) {
module.exports = {
  "en": {
    "required": "This field is required.",
    "email": "Please enter a proper email.",
    "firstName": "Please enter a proper first name.",
    "lastName": "Please enter a proper last name.",
    "zipcode": "Please enter a proper zipcode.",
    "phone": "Please enter a proper phone number.",
    "state": "Please enter a proper state.",
    "city": "Please enter a proper city."
  },
  "es": {
    "required": "Este campo es obligatorio.",
    "email": "Por favor usa una direcci&oacute;n de correo electr&oacute;nico correcta.",
    "firstname": "Por favor ingresa un nombre.",
    "lastname": "Por favor ingresa un apellido.",
    "zipcode": "Por favor ingrese un c&oacute;digo postal valido.",
    "phone": "Por favor ingresa un n&uacute;mero de tel&eacute;fono correcto.",
    "state": "Por favor ingresa un estado apropiado.",
    "city": "Por favor introduzca una ciudad adecuada."
  }
};
},{}],"modules/validators.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  maxlength: function maxlength(value, max) {
    if (value.length > max) {
      return FALSE;
    }
   ...
   */
  phone_ext: function phone_ext(value) {
...
exports.default = _default;
},{}],"modules/validation.js":[function(require,module,exports) {
"use strict";
...
var _validationMessages = _interopRequireDefault(require("./validation-messages.json"));
...
var Validation = /*#__PURE__*/function () {
  function Validation() {
    ...
    this.validators = _validators.default;
  }
  ...
  _createClass(Validation, [{
    ...
    value: function validate(form) {
      ...
      var self = this,
          isValid = true;
      self.errorList = [];
      self.i18nValidator = _validationMessages.default[document.documentElement.getAttribute('lang')];
      var inputs = form.querySelectorAll('input[required], select[required], input[data-validators]');
    ...
    value: function validateField($input) {
      ...
      if ($input.dataset.validationProxy) {
        var proxiedFields = $input.dataset.validationProxy.split(',');

        for (var i = 0; i < proxiedFields.length; i++) {
          var form = _domHelpers.default.closest($input, 'fieldset');

          var $proxyInput = form.querySelector('[name="' + proxiedFields[i] + '"]');
      ...
      if (!silent) {
        var validatedEl = _domHelpers.default.prev($input, '.form-validated');
        ...
        var _err = _domHelpers.default.prev($input, '.form-error');

        if (_err) {
          _err.parentNode.removeChild(_err);
        }

        var err2 = _domHelpers.default.prev($input, '.form-error');
        ...
        if ($input.dataset.compoundField) {
          var $compoundFieldContainer = _domHelpers.default.closest($input, '.compound-field');
      ...
      if (errors.length == 0) {
        ...
        for (var _i in errors) {
          if (!silent) {
            ariaDescribedby = $input.getAttribute('id') ? "error in filed ".concat($input.getAttribute('id')) : 'error in field';
            $input.setAttribute('aria-describedby', ariaDescribedby);
            this.addError($input, errors[_i].message, ariaDescribedby);
            break;
          }
        }
    ...
    key: "getFieldErrors",
    value: function getFieldErrors($input) {
      var self = this;
      var response = [];
      ...
      if ($input.hasAttribute('required') && !_validators.default.required($input.value)) {
        response.push({
          input: $input,
          type: 'required',
      ...
      if (type === 'email') {
        if (!_validators.default.email($input.value)) {
          response.push({
            input: $input,
            type: 'email',
      ...
      if ($input.hasAttribute('maxlength') && !_validators.default.maxlength($input.value, $input.getAttribute('maxlength'))) {
      ...
      if (inputValidators) {
        ...
        for (var i in inputValidatorArr) {
          try {
    ...
    key: "addError",
    value: function addError($input, errorMessage, ariaDescribedby) {
      var self = this;
      ...
      if ($input.matches('select')) {
        var options = _domHelpers.default.siblings($input, '.select-options')[0];

        options.insertAdjacentHTML('afterend', '<div class="form-error-icon"></div>');
        options.insertAdjacentHTML('afterend', "<div class=\"form-error\" id=\"".concat(ariaDescribedby, "\"> ").concat(errorMessage, " </div>"));

        _domHelpers.default.next($input, '.select-trigger').classList.add('is-error');
      } else {
        if ($input.dataset.compoundField) {
          var compoundField = _domHelpers.default.closest($input, '.compound-field');

          compoundField.insertAdjacentHTML('afterend', '<div class="form-error-icon"></div>');
          compoundField.insertAdjacentHTML('afterend', "<div class=\"form-error\"> ".concat(errorMessage, " </div>"));
        } else {
          $input.insertAdjacentHTML('afterend', '<div class="form-error-icon"></div>');
          $input.insertAdjacentHTML('beforebegin', "<div class=\"form-error\" id=\"".concat(ariaDescribedby, "\"> ").concat(errorMessage, " </div>"));
        }
      }
    ...
    key: "addValidated",
    value: function addValidated($input) {
      this.resetState($input);
      $input.classList.add('is-valid');
      $input.insertAdjacentHTML('afterend', '<div class="form-valid-icon"></div>');

      if (_domHelpers.default.next($input, '.select-trigger')) {
        _domHelpers.default.next($input, '.select-trigger').classList.add('is-error');
      }
    }
    /**
    ...
    key: "removeValidated",
    value: function removeValidated($input) {
      this.resetState($input);
      $input.classList.remove('is-valid');

      var validIcon = _domHelpers.default.siblings($input, '.form-valid-icon')[0];

      validIcon && validIcon.removeChild(validIcon);

      var errorIcon = _domHelpers.default.siblings($input, '.form-error-icon')[0];

      errorIcon && errorIcon.removeChild(errorIcon);
    }
  }, {
    key: "resetState",
    value: function resetState($input) {
      var err = _domHelpers.default.next($input, '.form-error');

      err && err.parentElement.removeChild(_domHelpers.default.next($input, '.form-error'));

      var errorIcon = _domHelpers.default.siblings($input, '.form-error-icon');

      errorIcon[0] && errorIcon[0].parentElement.removeChild(errorIcon[0]);

      var validIcon = _domHelpers.default.siblings($input, '.form-valid-icon');

      validIcon[0] && validIcon[0].parentElement.removeChild(validIcon[0]);

      if ($input.matches('select')) {
        var icons = _domHelpers.default.siblings($input, '.form-error,.form-valid-icon,.form-error-icon');
      ...
      if ($input.dataset.compoundField) {
        ...
        var _icons = _domHelpers.default.siblings($compoundFieldContainer, '.form-error,.form-valid-icon,.form-error-icon');

        var _iterator3 = _createForOfIteratorHelper(_icons),
            _step3;
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _icon.parentElement.removeChild(_icon);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
    ...
    key: "getErrorMessage",
    value: function getErrorMessage(input, errorType) {
      var self = this,
...
exports.default = _default;
},{"./dom-helpers":"modules/dom-helpers.js","./validation-messages.json":"modules/validation-messages.json","./validators":"modules/validators.js"}],"modules/text-masks.js":[function(require,module,exports) {
"use strict";
...
},{}],"modules/enhanced-input.js":[function(require,module,exports) {
"use strict";
...
var _textMasks = _interopRequireDefault(require("./text-masks"));
...
var EnhancedInput = function EnhancedInput(options) {
  var _this = this;

  _classCallCheck(this, EnhancedInput);

  _defineProperty(this, "_onKeyUp", function () {
    if (_this.$input.value) {
      _this.el.classList.add('is-edited');
    } else {
      _this.el.classList.remove('is-edited');
    }
  });

  _defineProperty(this, "_onFocus", function () {
    _this.el.classList.add('is-edited');
  });

  _defineProperty(this, "_onBlur", function () {
    if (_this.$input.value === undefined || _this.$input.value === '') {
      _this.el.classList.remove('is-edited');
    }

    if (_this.$input.getAttribute('name') === 'firstName' || _this.$input.getAttribute('name') === 'lastName') {
      var proxyInput = (0, _domHelpers.closest)(_this.el, 'form').querySelector('[name="fullName"]');

      _validation.default.validateField(proxyInput);
    } else {
      setTimeout(function () {
        _validation.default.validateField(_this.$input);
      }, 0);
    }
  });
  ...
  var mask = this.$input.dataset.mask || _textMasks.default[this.$input.dataset.maskType || options.maskType];

  if (mask) {
    (0, _vanillaTextMask.maskInput)({
...
},{"./dom-helpers":"modules/dom-helpers.js","./validation":"modules/validation.js","./text-masks":"modules/text-masks.js","vanilla-text-mask":"../node_modules/vanilla-text-mask/dist/vanillaTextMask.js"}],"modules/phone-input.js":[function(require,module,exports) {
"use strict";
...
var _enhancedInput = _interopRequireDefault(require("./enhanced-input"));
...
var PhoneInput = /*#__PURE__*/function (_EnhancedInput) {
  _inherits(PhoneInput, _EnhancedInput);

  var _super = _createSuper(PhoneInput);

  function PhoneInput(options) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "_ieIsdPhoneHandle", function (evt) {
      if (_this.$input.value === '1 ' && evt.keyCode == 8) {
        _this.$input.value = '';
      }
    });

    _defineProperty(_assertThisInitialized(_this), "_onKeyUp", function (evt) {
      if (_this.$input.value) {
        _this.el.classList.add('is-edited');
      } else {
        _this.el.classList.remove('is-edited');
      ...
      if (_this.$input.value === '1' && _this.$input.value.length == 1) {
        if (_this.createMask) {
          _this.createMask.destroy();
        }

        _this.createMask = textMask.maskInput({
          inputElement: _this.$input,
          mask: _textMasks.default.isd_phone,
          guide: false
        });
      } else if (_this.$input.value.length == 4 && _this.$input.value.charAt(0) >= 2 && _this.$input.value.charAt(0) <= 9) {
        if (_this.createMask) {
          _this.createMask.destroy();
        }
        ...
        _this.createMask = textMask.maskInput({
          inputElement: _this.$input,
          mask: _textMasks.default.phone,
          guide: false
        });
      } else if (_this.$input.value.length == 0 || _this.$input.value.length == 1) {
        if (_this.createMask) {
          _this.createMask.destroy();
        }
        ...
        _this.createMask = textMask.maskInput({
          inputElement: _this.$input,
          mask: _textMasks.default.default,
          guide: false
        });
      }
    });

    _this.$input.addEventListener('keydown', _this._ieIsdPhoneHandle);

    _this.$input.addEventListener('keyup', _this._onKeyUp);
  ...
  return PhoneInput;
}(_enhancedInput.default);

exports.default = PhoneInput;
},{"./enhanced-input":"modules/enhanced-input.js","./text-masks":"modules/text-masks.js","vanilla-text-mask":"../node_modules/vanilla-text-mask/dist/vanillaTextMask.js"}],"modules/get-enhanced-input.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = getEnhancedInput;
...
function getEnhancedInput(options, type) {
  switch (type) {
    case 'phone':
      return new _phoneInput.default(options);

    default:
      return new _enhancedInput.default(options);
  }
}
},{"./enhanced-input":"modules/enhanced-input.js","./phone-input":"modules/phone-input.js"}],"modules/get-form-data.js":[function(require,module,exports) {
"use strict";
...
function getFormData(form) {
  ...
  var _iterator = _createForOfIteratorHelper(formSerialized),
      _step;
...
},{}],"modules/entryPoint.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(Component, Selector) {
...
function extractDataFromElement(el) {
  ...
  return Object.keys(data).filter(function (k) {
    ...
    try {
      ...
      var prop = k.split('cfg')[1].replace(/^([A-Z])/g, function (x, up) {
...
},{}],"subscribe.js":[function(require,module,exports) {
"use strict";
...
var _form = _interopRequireDefault(require("./scss/form.scss"));

require("babel-polyfill");

var _domHelpers = require("./modules/dom-helpers");

var _compoundField = _interopRequireDefault(require("./modules/compound-field"));

var _validation = _interopRequireDefault(require("./modules/validation"));

var _getEnhancedInput = _interopRequireDefault(require("./modules/get-enhanced-input"));

var _getFormData = _interopRequireDefault(require("./modules/get-form-data"));

var _entryPoint = _interopRequireDefault(require("./modules/entryPoint"));
...
var Subscribe = /*#__PURE__*/function () {
  function Subscribe(options) {
    ...
    _defineProperty(this, "checkCompletionState", function () {
      if (_validation.default.validate(_this.config.el.form, true)) {
        _this.config.el.submit.disabled = false;
        _this.config.el.submit.innerHTML = _this.config.el.submit.dataset.complete;
      } else {
        _this.config.el.submit.disabled = true;
        _this.config.el.submit.innerHTML = _this.config.el.submit.dataset.default;
      }
    });

    _defineProperty(this, "submitForm", /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                evt.preventDefault();
                data = (0, _getFormData.default)(_this.config.el.form); // const response = await callService('submitSubscribe', data);
                // mock service call:

                _context.next = 4;
                return _this.submitSubscribe(data);
    ...
    _defineProperty(this, "onResponse", function (response) {
      _this.config.el.form.classList.remove(IS_VISIBLE_CLASS);

      _this.config.el.confirmation.classList.add(IS_VISIBLE_CLASS);
    });
  ...
  _createClass(Subscribe, [{
    ...
    value: function addEventListeners() {
      ...
      (0, _domHelpers.on)(this.config.el.form, 'click', '.submit-button', function (evt) {
        return _this2.submitForm(evt);
      });
      (0, _domHelpers.on)(this.config.el.form, 'input', 'input,textarea', function (evt) {
        return _this2.onInputKeyup(evt);
      });
      (0, _domHelpers.on)(this.config.el.form, 'keyup', 'input,textarea', function (evt) {
        return _this2.onInputKeyup(evt);
      });
      (0, _domHelpers.on)(this.config.el.form, 'change', 'input,textarea', function (evt) {
        return _this2.onInputKeyup(evt);
      });
      (0, _domHelpers.on)(this.config.el.form, 'paste', 'input,textarea', function (evt) {
        return _this2.onInputKeyup(evt);
      });
      (0, _domHelpers.on)(this.config.el.form, 'focusout', 'input,textarea', function (evt) {
        return _this2.onInputKeyup(evt);
      });
      (0, _domHelpers.on)(this.config.el, 'click', '.ccpa-disclaimer', function (evt) {
        return _this2.disclaimerClick(evt);
      });
    }
  }, {
    key: "onInputKeyup",
    ...
    value: function render() {
      new _compoundField.default({
        el: this.config.el.form.querySelector('.compound-field'),
        fields: ['firstName', 'lastName']
      });
      var inputs = this.config.el.form.querySelectorAll('.enhanced-input');
     ...
     * Mock service
     */
    value: function submitSubscribe(data) {
...
new _entryPoint.default(Subscribe, '.subscribe');
},{"./scss/form.scss":"scss/form.scss","babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./modules/dom-helpers":"modules/dom-helpers.js","./modules/compound-field":"modules/compound-field.js","./modules/validation":"modules/validation.js","./modules/get-enhanced-input":"modules/get-enhanced-input.js","./modules/get-form-data":"modules/get-form-data.js","./modules/entryPoint":"modules/entryPoint.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","subscribe.js"], null)
//# sourceMappingURL=/subscribe.20b85b7f.js.map